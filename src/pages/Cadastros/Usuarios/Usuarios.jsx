...
export default function UsuariosPage() {
    ...
    const buscarDados = async () => {
        ...
        try {
            ...
            const response = await axios.get(`${API_URL}/v1/system_users`, { params });
    ...
    const salvarFormulario = async (registro) => {
        ...
        try {
            if (registroEditando) {
                ...
                // POST (criação)
                const response = await axios.post(`/v1/system_users`, registro);
                buscarDados();
            }
        ...
        try {
            ...
            await Promise.all(
                idsParaExcluir.map((id) =>
                    axios.delete(`/v1/system_users/${id}`)
                )
            );
    ...
    return (
        <div className="p-4 px-8 max-w-full mx-auto">
            ...
            <div className="mb-6 border border-gray-300 rounded bg-gray-50 p-4 shadow-sm">
                <h2 className="font-semibold text-xl mb-4 text-gray-700">Usuarios</h2>
